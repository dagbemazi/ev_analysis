...
def insert_and_fetch_id(ev:tuple):
    ...
    try:
        ...
        cur.execute("SELECT id FROM Vin_1_10 where vin_1_10 = ?;", (ev.vin,))
        ...
        cur.execute("SELECT id FROM State where state = ?;", (ev.state,))
        ...
        cur.execute("INSERT OR IGNORE INTO GeocodedColumn(geocoded_column) VALUES ( ? )", (ev.geocode,))
        ...
        cur.execute("INSERT OR IGNORE INTO CensusTract(census_tract_2020) VALUES ( ? )", (ev.census_tract,))
        cur.execute("SELECT id FROM CensusTract where census_tract_2020 = ?;", (ev.census_tract,))
